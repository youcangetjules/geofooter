...
Public Sub ShowDiagnosticsDialog()
    ...
    If TryShowPythonDiagnosticsDialog() Then
        MSCANModLogging.WriteLogInfo "ShowDiagnosticsDialog: interactive dialog closed."
        Exit Sub
    End If
...
Private Function TryShowPythonDiagnosticsDialog() As Boolean
    ...
    If exitCode <> 0 Then
        MSCANModLogging.WriteLogWarn "Diagnostics dialog exit " & exitCode
        Exit Function
    End If
