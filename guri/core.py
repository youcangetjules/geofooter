...
class GURIDatabase:
    ...
    def __init__(self, 
        ...
        if self.db_type == "postgres":
            ...
            if db_path is None:
                try:
                    from geofooter.paths import datastore_path, get_install_root
...
COMMAND LINE USAGE:
    python -m guri.core         - Run example demonstration
    python -m guri.core --help  - Display this help message
...
def main():
    ...
    print("Run 'python -m guri.core --help' for detailed usage information.")
    print("=" * 80)
